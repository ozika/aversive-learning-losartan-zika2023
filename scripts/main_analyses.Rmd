...
em <- emmeans(m2, ~ drug_str | rev_type_4plot_swchp /visit_str) 
pairs(em, adjust=adjustment_method)
a <- summary(pairs(em, adjust=adjustment_method))
eff<-effectsize::t_to_eta2(t=a$t.ratio, df_error = a$df, alternative = "two.sided")
a<-cbind(a, eff)
...
a<-cbind(a, eff)
a
#pairs(pairs(pairs(emmeans::regrid(em)), by = NULL), by = NULL)  

#  (losartan - placebo acq v1) - (losartan - placebo acq v2)  0.15112 0.0410 34.9   3.684  0.0093
#  (losartan - placebo ext v1) - (losartan - placebo ext v2) -0.12996 0.0405 33.5  -3.207  0.0322
#  (losartan - placebo acq v1) - (losartan - placebo acq v3)  0.17172 0.0439 38.9   3.916  0.0044
#  (losartan - placebo ext v1) - (losartan - placebo ext v3) -0.13467 0.0407 36.0  -3.305  0.0243

#  ((losartan - placebo acq v1) - (losartan - placebo acq v2)) - ((losartan - placebo ext v1) - (losartan - placebo ext v2))  0.28108 0.0309 33.5   9.095  <.0001
#  ((losartan - placebo acq v1) - (losartan - placebo acq v3)) - ((losartan - placebo ext v1) - (losartan - placebo ext v3))  0.30639 0.0356 36.0   8.596  <.0001
